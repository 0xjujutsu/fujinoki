// Ripped from https://github.com/serenity-rs/serenity/blob/src/model/application.rs
// This file is under the ISC License
...
#[turbo_tasks::value(transparent, shared, serialization = "custom", eq = "manual")]
#[derive(
    Copy,
    Clone,
    Default,
