//! From next-swc/crates/next-core/src/next_server/resolve.rs
...
use turbopack_binding::{
    turbo::{
        ...
        tasks::{trace::TraceRawVcs, RcStr, Value, Vc},
        tasks_fs::{glob::Glob, FileJsonContent, FileSystemPath},
    },
    turbopack::core::{
...
// TODO(turbopack) move that to turbo
